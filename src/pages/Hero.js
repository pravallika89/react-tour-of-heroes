...
const powers=['super Strength','super speed','regeneration','flight','telekinesis']
const HeroPage=()=>{
         ...
         <div className="card" >
           <div className='row no-gutters'>
             <div className='col-md-4 th-img-container'>
                ...
                <div className='th-hero-img' style={{background:`url(${hero.image_url})`}}></div>
             </div>
               ...
               <div className='card-body'>
                 ...
                 <div className='th-card-header d-flex justify-content-between'>
                   <span>
                     ...
                     onClick={()=>{updateFeatured(hero.id)}}>{hero.featured ? <FaStar style={{color:'gold'}} /> : <FaRegStar />}</a>
                   </span>
                   <span>
                     {hero.publisher}
                   </span>
                 ...
                 <div className='detail'>
                   ...
                   <p className='ml-5'>Lorem epsum</p>
                   </div>
                   ...
                   <p className='ml-5'>
                     {
                       powers.map((power,i)=>{
                         return(
                           <span className="badge badge-pill badge-success" key={i}> {power}
                   ...
                   <p className='ml-5'>{hero.characters ?.map((ch,i)=>{
                     return(
                       <span key={i}>
                         {ch}
